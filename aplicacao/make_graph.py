class Make_Graph():
	...
	def plot_graph(self):
		import igraph
		import nltk.metrics.spearman as spearman
		import scipy.stats as stats
		import time


		grafo = igraph.Graph()
		grafo = grafo.Read_Edgelist('rede-cora\subelj_cora\\base.txt', directed=self.direcionada)
		...
		igraph.plot(grafo, time.time() + ".svg", bbox=(800, 700), margin=20, vertex_label=vindex1, edge_arrow_size=0.3, vertex_color=(255, 0, 0), vertex_label_color=(225, 225, 0), vertex_label_size=1, vertex_dist=200)
